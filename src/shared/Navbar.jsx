...
const Navbar = () => {
  const { user, darkTheme, setDarkTheme, loading } = useContext(AuthContext);
              ...
              <div>
                {user ? (
                  <div className="flex items-center gap-3">
                    <p
                      className={`font-semibold px-4 py-2 hidden lg:block ${
                        darkTheme
                          ? "bg-[#2257ca] text-white"
                          : "bg-[#2257ca] text-white"
                      } rounded-lg`}
                    >
                      {user.displayName}
                    ...
                    <div className="dropdown dropdown-end z-40 text-black">
                      ...
                      >
                        ...
                        <li>
                          <button className="btn bg-[#2257ca] text-white w-full rounded-lg text-center btn-sm">
                            Logout
                          </button>
                        </li>
                        <hr />
                        <>
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <button onClick={() => setDarkTheme(!darkTheme)} className="btn bg-main hover:bg-main text-white  rounded-lg  btn-sm">
                                {darkTheme ? (
                                  <BsSunFill></BsSunFill>
                                ) : (
